      ...
      <div className="faq-container">
        <div className="accordian">
          <Accordion className={useStyles().frame} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <AccordionDetails className={useStyles().answer}>
              A hackathon is a place where you can collaborate with others and express your creativity to create a product that solves some real-world problem. 
              At GraceHacks, students of all different backgrounds and experiences will gather together to develop an idea and realize that solution all within the span of 24 hours!
              </AccordionDetails>
          </Accordion>
          ...
          <Accordion className={useStyles().frame} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
            ...
            <AccordionDetails className={useStyles().answer}>
              All female-identifying or non-binary college students (both undergraduates and graduates) 
              are invited to attend, even with no prior experience necessary!
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className={useStyles().frame} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
            ...
            <AccordionDetails className={useStyles().answer}>
              No worries! We’ll have a short activity at the beginning of the hackathon, 
              where you can meet others who you might want to collaborate with!
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className={useStyles().frame} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
            ...
            <AccordionDetails className={useStyles().answer}>
              Our hackathon is catered towards beginners, and is a wonderful place to explore software development! Not a technical major? Don’t worry ~ the best hackathon teams delicately balance graphic designers, project managers, and business associates as well!</AccordionDetails>
          </Accordion>
        </div>
        <div className="accordian">
          <Accordion className={useStyles().frame} expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
            ...
            <AccordionDetails className={useStyles().answer}>
              This is a hybrid event! You can participate in person at the Stevenson Event Center or participate
              online if you have internet connection and access to Zoom!</AccordionDetails>
          </Accordion>
          ...
          <Accordion className={useStyles().frame} expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
            ...
            <AccordionDetails className={useStyles().answer}>Hardware products, software applications, gaming interfaces~ if you can dream it, you can build it!</AccordionDetails>
          </Accordion>

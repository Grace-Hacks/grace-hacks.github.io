    ...
    <div class="about-container" id="mission">
      ...
      <img class="petal" src={Petal}></img>
        <div class="info">
          ...
          <div class="description"> <span class="bold_desc">Register to participate in our 3rd annual BEGINNER-FRIENDLY Hackathon TODAY!</span> The aim of GraceHacks is to foster a welcoming and supportive hackathon environment for students of diverse genders. Particularly women, nonbinary students, and anyone who struggles to feel like they belong in technical spaces. GraceHacks strives to empower these underrepresented groups and ensure that they have the confidence to create without inherent bias or sexism.</div>

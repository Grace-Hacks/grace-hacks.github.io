...
function Sponsors() {
  return (
    ...
    <Container style={{paddingTop:"50px"}} id="-section">
      ...
      <a href = "https://www.kingston.com/us" target="_blank" rel="noopener noreferrer">
      ...
      <a href = "https://www.nutanix.com/en" target="_blank" rel="noopener noreferrer">
        <img style={{paddingRight:"25px"}} src={require('./Nutanix.jpeg')} width = "350px" height = "350px" alt="Nutanix-1000"/>
      </a>

      <a href = "https://www.cdkglobal.com/us" target="_blank" rel="noopener noreferrer">
        <img style={{paddingRight:"25px", paddingLeft:"25px"}} src={require('./CDKGlobal.png')} width = "300px" height = "400px" alt="cdkGlobal-$1000"/>
      </a>

      <a href = "https://www.santacruzworks.org/" target="_blank" rel="noopener noreferrer">
      ...
      <a href = "https://rstudio.com/" target="_blank" rel="noopener noreferrer">
      ...
      <a href = "https://www.ai-camp.org/" target="_blank" rel="noopener noreferrer">

  ...
  <div>
    ...
    <div class="faq-section">
      <div class="faq-row" style={{minHeight: "515px"}}>
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("one")}}><div class= 'ques'>What is a hackathon?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("two")}}><div class= 'ques'>Who can attend?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("three")}}><div class= 'ques'>What if I don’t have a team or idea?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("four")}}><div class= 'ques'>What if I don’t know how to code?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("five")}}><div class= 'ques'>How do I attend?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("six")}}><div class= 'ques'>What can I create?</div> <img src={require("./vector.png")} class="arrow"/></div>
        ...
        <div class="module">
          <div class="faq-title" onClick={() => {toggleState("seven")}}><div class= 'ques'>How much does it cost?</div> <img src={require("./vector.png")} class="arrow"/></div>
